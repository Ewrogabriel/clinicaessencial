...
export const professionalSchema = z.object({
    ...
    registro_profissional: z.string().min(2, "Registro profissional é obrigatório").optional().or(z.literal("")),
    ...
    cor_agenda: z.string().regex(/^#[0-9A-Fa-f]{6}$/, "Cor inválida").optional().or(z.literal("")),
});
