...
const ProfessionalDashboard = () => {
  ...
  const statusColors: Record<string, string> = {
    ...
    confirmado: "bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-300",
    realizado: "bg-muted text-muted-foreground",
    cancelado: "bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-300",
    falta: "bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-300",
  };
