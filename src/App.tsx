...
import { ClinicThemeWrapper } from "@/components/layout/ClinicThemeWrapper";
...
const PublicNotaFiscal = lazy(() => import("./pages/PublicNotaFiscal"));
                  ...
                  <Suspense fallback={<LazyLoadFallback />}>
                    <Routes>
                      ...
                      >
                        ...
                        <Route path="/matriculas" element={<RequireRole roles={["admin", "gestor", "master", "secretario", "profissional"]}><Matriculas /></RequireRole>} />
